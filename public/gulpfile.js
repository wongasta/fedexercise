...
var paths = {
    lib: ['bower_components/angular/angular.js', 'bower_components/jquery/jquery.js', 'bower_components/angular-route/angular-route.js',
    'bower_components/underscore/underscore.js'],
    ng: ['ng/**/*.js'],
    lintjs: ['ng/**/*.js'],
    sass: ['sass/**/*.sass', 'sass/**/*.scss'],
    css: ['bower_components/bootstrap/dist/css/bootstrap.css', 'bower_components/font-awesome/css/font-awesome.css']
};
